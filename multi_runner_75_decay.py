...
output_path = 'output_75_decay0.0001'
xml_path = 'MC75.xml'
dnn1_yaml = 'networks/State2Image2x20ImageSize5x15Decay0.1.yml'
dnn2_yaml = 'networks/Image2State1x10ImageSize5x15Decay0.0001.yml'
